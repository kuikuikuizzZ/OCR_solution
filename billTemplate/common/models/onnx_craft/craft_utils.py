#  borrowed from https://github.com/clovaai/CRAFT-pytorch/craft_utils.py
# -*- coding: utf-8 -*-
import numpy as np
import cv2
import math
...
def getDetBoxes(textmap,
                linkmap,
                text_threshold,
                link_threshold,
                low_text,
                poly=False):
    boxes, labels, mapper = getDetBoxes_core(textmap, linkmap, text_threshold,
